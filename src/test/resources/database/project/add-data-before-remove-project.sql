...
insert into tasks (id, name, description, priority, status, due_date, project_id, assignee_id) values (2, "taskName1", "taskDescription", "MEDIUM", "IN_PROGRESS", "2150-01-01", 1, 2);
...
insert into attachments (id, task_id, dropbox_file_id, filename, upload_date) values (2, 2, "dropbox_file_id2", "filename2", "2145-01-01-00-00-00.000");
insert into comments (id, task_id, user_id, text, timestamp) values (1, 1, 2, "text", "2145-01-01-00-00-00.000");
insert into comments (id, task_id, user_id, text, timestamp) values (2, 2, 2, "text1", "2145-01-01-00-00-01.000");
...
insert into labels_tasks (label_id, task_id) values (1, 2);
